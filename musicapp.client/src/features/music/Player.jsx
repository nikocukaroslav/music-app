...
import {playNextSong, playPreviousSong, setIsPlaying, shuffleMusic,} from "@/features/music/musicSlice.js";
    ...
    return (
        <AudioPlayer
            ...
            customAdditionalControls={[
                <div
                    key={musicUrl}
                    className="max-[764px]:overflow-hidden max-[764px]:w-full "
                >
                    <p className={" max-[764px]:music-name max-[764px]:w-[30vw] py-2 max-[764px]:text-sm"}>
                        {currentMusicName}
                    </p>
                </div>,
            ]}
