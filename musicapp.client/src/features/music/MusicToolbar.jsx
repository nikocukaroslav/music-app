...
import {cleanSelected, removeMusic, setLooping, setShuffling, toggleSelectMode,} from "@/features/music/musicSlice.js";
    ...
    return (
        <>
            <nav className={`flex justify-between items-center ${className} `}>
                {music.length > 0 && (
                    <div className="flex gap-2 max-[764px]:w-full">
                ...
                {albumToolsActive && <span className="text-xl max-[764px]:hidden">{activeAlbum?.name}</span>}
